...
bool init_opencl() {
  	...
  	std::string binary_file = getBoardBinaryFile("fuel_cl", *device);
  	//printf("Using AOCX: %s\n", binary_file.c_str());
  	...
  	// Kernel.
  	const char *kernel_name = "fuel_kernel";
...
void run() {
	...
	char last_input = '0';	
	printf("You will enter either a 0 or a 1 for DRIVE or REFUEL\n"
	       "Enter a q to quit.\n");
	...
	while(last_input != 'q'){
		...
		if(last_input != '0' & last_input != '1' && last_input != 'q'){
			...
			if(last_input == '1' || last_input == '0'){
				...
				switch(output[0]){
					case 0:
						printf("The machine has been reset\n");
						break;
					case 1:
						printf("You now have a full tank of gas!\n");
						break;
					case 2:
						printf("You now have 2/3 of a tank of gas!\n");
						break;
					case 7:
						printf("You now have 1/3 of a tank of gas! You may want to refuel soon...\n");
						break;
					case 4: 
						printf("You are out of gas.  Time to walk :(\n");
						break;
					case 12:
						printf("Currently refueling.\n");
						break;
					case 13: 
						printf("You are walking with a gas can to refill your tank partially.\n");
						break;
					default:
						printf("You are driving!\n");
						break;
				}
			}
		}
