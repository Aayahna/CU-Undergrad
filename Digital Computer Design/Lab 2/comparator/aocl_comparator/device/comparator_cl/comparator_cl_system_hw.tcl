...
set_module_property NAME comparator_cl_system
set_module_property VERSION 14.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME comparator_cl_system
...
### SLAVE interface avs_comparator_kernel_cra
add_interface avs_comparator_kernel_cra avalon end
set_interface_property avs_comparator_kernel_cra addressAlignment DYNAMIC
set_interface_property avs_comparator_kernel_cra burstOnBurstBoundariesOnly false
set_interface_property avs_comparator_kernel_cra explicitAddressSpan 0
set_interface_property avs_comparator_kernel_cra holdTime 0
set_interface_property avs_comparator_kernel_cra isMemoryDevice false
set_interface_property avs_comparator_kernel_cra isNonVolatileStorage false
set_interface_property avs_comparator_kernel_cra linewrapBursts false
set_interface_property avs_comparator_kernel_cra maximumPendingReadTransactions 1
set_interface_property avs_comparator_kernel_cra printableDevice false
set_interface_property avs_comparator_kernel_cra readLatency 0
set_interface_property avs_comparator_kernel_cra readWaitTime 0
set_interface_property avs_comparator_kernel_cra setupTime 0
set_interface_property avs_comparator_kernel_cra timingUnits Cycles
set_interface_property avs_comparator_kernel_cra writeWaitTime 0
set_interface_property avs_comparator_kernel_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_comparator_kernel_cra ENABLED true
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_read read Input 1
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_write write Input 1
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_address address Input 4
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_writedata writedata Input 64
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_byteenable byteenable Input 8
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_readdata readdata Output 64
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_readdata readdata Output 64
add_interface_port avs_comparator_kernel_cra avs_comparator_kernel_cra_readdatavalid readdatavalid Output 1
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL comparator_cl_system
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file comparator_cl.v SYSTEM_VERILOG PATH comparator_cl.v TOP_LEVEL_FILE
add_fileset_file comparator_cl_system.v SYSTEM_VERILOG PATH comparator_cl_system.v TOP_LEVEL_FILE
...
add_fileset_file comparator_cl.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/comparator/comparator_cl.vhd TOP_LEVEL_FILE
add_fileset_file Comparator1.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/comparator/Comparator1.vhd TOP_LEVEL_FILE
add_fileset_file generic_nand.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/comparator/generic_nand.vhd TOP_LEVEL_FILE
add_fileset_file Comparator16.vhd VHDL PATH ./libraries/no_vendor/no_lib_name/no_version/comparator/Comparator16.vhd TOP_LEVEL_FILE
...
set_fileset_property SIM_VERILOG TOP_LEVEL comparator_cl_system
add_fileset_file comparator_cl.v SYSTEM_VERILOG PATH comparator_cl.v TOP_LEVEL_FILE
add_fileset_file comparator_cl_system.v SYSTEM_VERILOG PATH comparator_cl_system.v TOP_LEVEL_FILE
add_fileset_file acl_data_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_data_fifo.v TOP_LEVEL_FILE
add_fileset_file acl_fifo.v SYSTEM_VERILOG PATH $::env(ALTERAOCLSDKROOT)/ip/acl_fifo.v TOP_LEVEL_FILE
