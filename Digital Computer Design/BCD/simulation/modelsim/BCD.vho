...
-- Equation(s):
-- \dut|Mux3~0_combout\ = ( \SW[2]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( !\SW[2]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( \SW[2]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[3]~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001100110011001111001100110011001100110011001100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \dut|Mux2~0_combout\ = ( !\SW[2]~input_o\ & ( \SW[1]~input_o\ ) ) # ( \SW[2]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[3]~input_o\ ) ) ) # ( !\SW[2]~input_o\ & ( !\SW[1]~input_o\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111111111111111000011110000111111111111111111110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \dut|Mux1~0_combout\ = ( !\SW[2]~input_o\ & ( !\SW[1]~input_o\ & ( \SW[3]~input_o\ ) ) )
...
-- Equation(s):
-- \dut|Mux0~0_combout\ = ( \SW[2]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( !\SW[2]~input_o\ & ( \SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( \SW[2]~input_o\ & ( !\SW[1]~input_o\ & ( !\SW[3]~input_o\ ) ) ) # ( !\SW[2]~input_o\ & ( 
-- !\SW[1]~input_o\ ) )
